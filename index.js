...
app.post('/submitform', async (req, res) => {
    ...
    try {
        ...
        if ((await client.query('SELECT Client FROM Form_Responses WHERE Client = ($1)', [SessionID])).rowCount === 0) {
            await client.query(`INSERT INTO Form_Responses(Client, Current_Form, ${req.body.CurrentForm}_Data) VALUES (($1), ($2), ($3))`, [SessionID, req.body.CurrentForm, req.body.Data]);
        }
        else {
